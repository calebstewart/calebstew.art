...
\name{{"{"}}{{ .Site.Params.profile.firstname }}{{"}{"}}{{ .Site.Params.profile.lastname }}{{"}"}}
\position{{"{"}}{{ replace $.Site.Params.profile.title ", " "{\\enskip\\cdotp\\enskip}" }}{{"}"}}
\address{{"{"}}{{ .Site.Params.profile.location }}{{"}"}}

{{ range $service, $id := .Site.Params.contacts }}
\{{ $service }}{{"{"}}{{ $id }}{{"}"}}
{{ end }}
